...
//note: for wi-fi interpretation only
...
class DFSystemCommandBlock : public ShellDevice
{
	Q_OBJECT

public:
	explicit DFSystemCommandBlock(kitBase::robotModel::RobotModelInterface &robotModel);
